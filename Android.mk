...
ifneq ($(filter waydroid_arm64 waydroid_arm64_only waydroid_aesl_2gb_arm64_only waydroid_arm,$(TARGET_DEVICE)),)
...
ifneq ($(filter waydroid_arm64 waydroid_arm64_only waydroid_aesl_2gb_arm64_only,$(TARGET_DEVICE)),)
