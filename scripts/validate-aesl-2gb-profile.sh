...
require_text "${repo_root}/BoardConfig.mk" 'TARGET_FLATTEN_APEX := true'
require_text "${repo_root}/BoardConfig.mk" 'OVERRIDE_TARGET_FLATTEN_APEX := true'
require_text "${repo_root}/BoardConfig.mk" 'BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := ext4'
require_text "${repo_root}/BoardConfig.mk" 'TARGET_USERIMAGES_SPARSE_EXT_DISABLED := true'
