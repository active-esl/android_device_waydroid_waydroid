...
require_text "${repo_root}/manifest_allocator_aidl.xml" '<hal format="aidl">'
require_text "${repo_root}/manifest_allocator_aidl.xml" '<name>android.hardware.graphics.allocator</name>'
require_text "${repo_root}/manifest_allocator_aidl.xml" '<name>IAllocator</name>'
